                ...
                <div class="col-md-3 arrival-grid simpleCart_shelfItem">
                    <div class="grid-arr">
                        <div  class="grid-arrival">
                            <figure>		
                                <a href="{{ route('product-details',[$data->id]) }}" class="new-gri">
                                    <div class="grid-img">
                                        <img  src="{{asset($data->product_image)}}" class="img-responsive" alt="">
                                    </div>
                                    <div class="grid-img">
                                        <img  src="{{asset($data->product_image)}}" class="img-responsive"  alt="">
                                    </div>			
                        ...
                        <div class="women">
                            <h6><a href="{{ route('product-details',[$data->id]) }}">{{ $data->product_name }}</a></h6>
                            <p><em class="item_price">Tk. {{ number_format($data->product_price) }}</em></p>
